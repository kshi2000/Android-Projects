...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    override fun onChildDraw(
        ...
        val editIconTop = itemHeight-editIconMargin*2
        val editIconLeft = itemView.right - itemView.left - editIconMargin
        val editIconRight = itemView.right - itemView.left
        val editIconBottom = itemHeight
